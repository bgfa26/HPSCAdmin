<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/site/employees/employees.Master" CodeBehind="acpdata.aspx.cs" Inherits="adminsite.site.employees.acp.acpdata" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header" id="titleHeader">
                Datos de cuenta, curso o permiso
            </h1>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6" style="margin-top:10px">
				                ...
				                <input type="text" class="form-control textinput" id="id" runat="server" autocomplete="off" maxlength="50" disabled="disabled">
