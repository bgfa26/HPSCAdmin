...
<asp:Content ID="ContentIndex" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../css/helpmark.css" rel="stylesheet">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6" style="margin-top:10px">
				                ...
				                <input type="text" class="form-control textinput" id="id" placeholder="XXXXXXXXXXXXXXXXXXXXXXXXX" runat="server" autocomplete="off" maxlength="25">
